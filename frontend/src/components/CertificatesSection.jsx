...
const CertificateCard = ({ title, issuer, date, logo, redirectLink }) => {
  return (
    <motion.div
      className="bg-[#121212] hover:bg-[#1a1a1a] transition-colors duration-200 p-4 rounded-lg flex items-center space-x-4 border border-[#1f1f1f] cursor-pointer"
    ...
    >
      <img
        src={logo}
        alt={issuer}
        className="h-10 w-10 object-contain rounded-md transition-transform duration-300 hover:opacity-80"
      />
      <div>
...
const CertificatesSection = () => {
  return (
    <div className="bg-[#0d0d0d] min-h-screen py-12 px-6 text-white flex flex-col items-center justify-center">
      <motion.h2
        className="text-4xl font-bold mb-2 mt-10"
      ...
      <motion.p
        ...
        viewport={{ once: true }}
      >
        I've participated in many contests, courses and tests and got certified
