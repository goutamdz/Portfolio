  ...
  return (
    <section className="py-20 px-4 md:px-12 bg-[#0d0d0d] text-white ">
      <div className="max-w-5xl mx-auto">
        ...
        <ExperienceCard logo={university} name={"Lovely Professional University, Punjab"} grade={"B.Tech - 8.11 CGPA"} address={"Jalandhar, Punjab-144411"} startDate={"Aug 2022"} endDate="present"/>
